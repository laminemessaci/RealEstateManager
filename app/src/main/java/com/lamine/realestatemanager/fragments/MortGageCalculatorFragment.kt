 ...
 * Use the [MortGageCalculatorFragment.newInstance] factory method to
...
class MortGageCalculatorFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment MortGageCalculatorFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MortGageCalculatorFragment().apply {
